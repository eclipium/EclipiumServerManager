    ...
    public static void CreateApp()
    {
        ...
        foreach (var app in apps)
        {
            if (app.DisplayName == name || app.ServiceName == serviceName ||
                File.Exists("/etc/systemd/system/" + serviceName + ".service") ||
                File.Exists("/usr/lib/systemd/system/" + serviceName + ".service"))
            {
        ...
        Console.WriteLine(
            "L'application a été créée, veuillez vous rendre dans le dossier de l'application a l'aide de la commande\n "
